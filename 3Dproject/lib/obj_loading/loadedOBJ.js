...
class LoadedOBJ extends Geometry {
   ...
   */
  constructor(objStr, mouseX, mouseY, Z, colors) {
    super();
    var k = 0;
	...
	this.modelMatrix.translate(mouseX*2/transAndScaleVal[1], mouseY*2/transAndScaleVal[1], Z*2/transAndScaleVal[1]);
	if(colors!=null){
  ...
  updateAnimation() {
    this.modelMatrix.rotate(1, 0.0, 1.0, 0.0);
  }
}
